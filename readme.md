...
Revisionable is installable via [composer](http://getcomposer.org/doc/00-intro.md), the details are on [packagist, here.](https://packagist.org/packages/develoopin/revisionable)

Add the following to the `require` section of your projects composer.json file:

```php
"develoopin/revisionable": "1.*",
```
...
```
php artisan migrate --path=vendor/develoopin/revisionable/src/migrations
```

For Laravel 4.x users:
```
php artisan migrate --package=develoopin/revisionable
```
...
> `cp vendor/develoopin/revisionable/src/migrations/2013_04_09_062329_create_revisions_table.php app/database/migrations/`
...
```php
use Develoopin\Revisionable\Revisionable;
...
opened in the GitHub issues tab for the main project, at [develoopin/revisionable/issues](https://github.com/develoopin/revisionable/issues)
